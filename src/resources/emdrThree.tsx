...
export const EmdrThree = (): JSX.Element => {
    return (
        <div className="textContainer">
            ...
            <ol type="1" className="baseText">
                <li>Start BLDAS: 15-30 seconds</li>
                <li>Take a breath. Let it go. What do you notice now? Go with that.</li>
                <li>Repeat 1 and 2 as long as the client reports change.</li>
                <li>When client no longer reports change, go back to the incident. When you think of the incident, what do you notice now? Go with that.</li>
                <ol type="a">
                    <li>If client reports something new, return to processing</li>
                    <li>If client reports no change, take a sud</li>
                </ol>
                <li>Take a SUD: When you think of the original incident, on a scale from 0-10, how disturbing is it now?</li>
                <li>If the SUD is greater than 0, return to processing</li>
                <li>Processing is complete when SUD is 0 or what makes sense under circumstances</li>
                <ol type="a">
                    <li>SUD 1 or 2: Is there anything that would help this go lower? Go with that. BLDAS</li>
                </ol>
                <li>If running out of time: We’re almost out of time. Would you like to do one more set or stop now?</li>
                <ol type="a">
                    <li>If necessary to restabilize: Use affect management skills</li>
                    <li>Debrief as appropriate</li>
                </ol>
            </ol>
            ...
            <ol type="1" className="baseText">
                ...
                <li>When you think of the incident and your positive belief, how true does it feel now, 1-7? Go with that. BLAD 5-10 seconds</li>
                <li>Take a breath, now when you think of the incident and your positive belief, how true does it feel, 1-7?</li>
                <ol type="a">
                    <li>If less than 7: process</li>
                    <li>If 7: add one more set of BLDAS</li>
                    <li>(Makes sense under circumstances)--not always a 7</li>
                </ol>
            </ol>
            <p>Body Scan</p>
            <ol type="1" className='baseText'>
